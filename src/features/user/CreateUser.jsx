...
//         value={username}
//         onChange={(e) => setUsername(e.target.value)}
//         className={`mb-8 w-72 rounded-full border ${isDarkMode ? "border-gray-600 bg-gray-700 text-gray-100" : "border-stone-400 bg-white text-gray-900"} px-4 py-2 text-sm transition-all duration-300 focus:outline-none focus:ring focus:ring-blue-400 md:px-6 md:py-3`}
//       />
